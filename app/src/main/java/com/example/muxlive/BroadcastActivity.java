    ...
    public void goLiveClicked(View view) {
        ...
        if (liveDesired) {
            ...
            if (rtmpCamera.prepareAudio() && rtmpCamera.prepareVideo()) {
                ...
                /**This device cant init encoders, this could be for 2 reasons:
                 * The encoder selected doesnt support any configuration setted
                 * or your device hasnt a H264 or AAC encoder (in this case you
                 * can see log error valid encoder not found)*/
            }
            // Start the stream!
            liveDesired = true;
